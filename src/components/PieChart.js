...
// yoinked straight from node modules cuz the fucking code there is broken and those pieces of shits cant fix the simplest of problems
...
export default class PieChart extends React.PureComponent {
    ...
    calculateRadius(arg, max, defaultVal) {
    ...
    render() {
        ...
        const _outerRadius = this.calculateRadius(outerRadius, maxRadius, maxRadius);
        const _innerRadius = this.calculateRadius(innerRadius, maxRadius, 0);
        const _labelRadius = this.calculateRadius(labelRadius, maxRadius, _outerRadius);
        ...
        return (
            <View style={style}>
                <View style={{ flex: 1 }} onLayout={event => this.onLayout(event)}>
                    {height > 0 && width > 0 && 
